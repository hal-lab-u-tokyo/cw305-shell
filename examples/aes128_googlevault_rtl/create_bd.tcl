...
# check IP
set aes_rtl_core_ip "user.org:user:googlevault_aes_core:1.0"
...
# append
set aes_rtl_core_ip_repo "[file join $ip_repo_loc "googlevault_aes_core_1_0" ]"
...
connect_bd_net [get_bd_pins usb_interface_0/external_trigger] [get_bd_pins aes_rtl_core_0/i_external_trigger]
