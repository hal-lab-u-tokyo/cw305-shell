...
# check IP
set aes_hls_core_ip "xilinx.com:hls:RSM_AES128Encrypt:1.0"

set aes_hls_core_ip_repo [file normalize [file join $scriptDir "hls_cw305_aes_rsm_enc/solution0/impl/ip"]]
...
# Create instance: RSM_AES128Encrypt_0, and set properties
set RSM_AES128Encrypt_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:RSM_AES128Encrypt:1.0 RSM_AES128Encrypt_0 ]
...
connect_bd_intf_net -intf_net RSM_AES128Encrypt_0_m_axi_data [get_bd_intf_pins RSM_AES128Encrypt_0/m_axi_data] [get_bd_intf_pins axi_smc/S00_AXI]
...
connect_bd_intf_net -intf_net usb_interface_0_axi_periph_M01_AXI [get_bd_intf_pins usb_interface_0_axi_periph/M01_AXI] [get_bd_intf_pins RSM_AES128Encrypt_0/s_axi_control]
...
assign_bd_address -offset 0x40000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces usb_interface_0/M00_AXI] [get_bd_addr_segs axi_led/S_AXI/Reg] -force
assign_bd_address -offset 0x80000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces usb_interface_0/M00_AXI] [get_bd_addr_segs RSM_AES128Encrypt_0/s_axi_control/Reg] -force
...
assign_bd_address -offset 0xC0000000 -range 0x00002000 -target_address_space [get_bd_addr_spaces RSM_AES128Encrypt_0/Data_m_axi_data] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] -force
